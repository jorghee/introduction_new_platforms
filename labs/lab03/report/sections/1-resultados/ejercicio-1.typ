...
#figure(
  image("../../img/report/ej1_codigo_mainactivity.png", width: 90%),
...
#figure(
  image("../../img/report/ej1_codigo_homescreen.png", width: 90%),
...
#figure(
  image("../../img/report/ej1_ejecucion_register.png", width: 90%),
  caption: [Pantalla de Registro de cuenta],
)

#figure(
  image("../../img/report/ej1_ejecucion_login.png", width: 90%),
  caption: [Pantalla de Inicion de sesión],
)

#figure(
  image("../../img/report/ej1_ejecucion_dinamico.png", width: 90%),
