...
Aunque los argumentos de navegación (como usamos en `navArgument("usuario")`) son útiles para datos primarios o simples como Strings y Enteros, *no son el mecanismo recomendado* para objetos complejos o dominios pesados. Para ello, utilizaríamos un *ViewModel compartido* @compose_viewmodel.
